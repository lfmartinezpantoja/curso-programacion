 ...
 * los salarios de los empleados de una empresa) y cuente cuantos empleados ganan menos
 * de 2 millones
 */
public class FindSalariesUnder2000000 {
    ...
    public static void main(String[] args) {
        ...
        /**
         * contar cuantos empleados ganan menos de 2 millones
         */
